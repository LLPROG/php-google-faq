    ...
    */
    $arr_questions = [
        ...
        [
            ...
            Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, nel /o Centro Google per la sicurezza online /c.\n
            
            /o Scopri /c quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo.\n"
        ],
        [
        ...
        <?php 
            foreach($arr_questions as $element) {
                ...
                foreach($para_in_answer as $para) {
                    $para_link = str_ireplace("/o", "<a href='#!' class='link'>", $para);
