    ...
    */
    $arr_questions = [
        ...
        [
            ...
            Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, nel /op Centro Google per la sicurezza online /c.\n
            
            /op Scopri /c quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo.\n"
        ],
        [
            ...
            <ol class='order-list'>
                <li>
                    La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi solla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:
        ...
        <?php 
            foreach($arr_questions as $element) {
                ...
                foreach($para_in_answer as $para) {
                    ...
                    //print answers
                    echo "<p class='paragraf' >$para_link_final</p>";
                }
            };
        ?>
